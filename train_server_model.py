...
def validate_dataset(data_dir):
    ...
    debug_dir = os.path.join("debug", "dataset_samples")
...
def main():
    ...
    try:
        ...
        print(f"Classes in server partition: {sorted(list(class_indices.keys()))[:5]}...")
        ...
        print('Building ResNet50 with SE and ECA blocks for facial recognition...')
        ...
        # Train the model
        print('Training server model with attention mechanisms...')
        try:
